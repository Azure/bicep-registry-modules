...
```bicep
module dailyCostsAlert 'br/public:cost/subscription-scheduled-action:1.1' = {
...
```bicep
module privateAlert 'br/public:cost/subscription-scheduled-action:1.1' = {
  name: 'privateAlert'
  params: {
    name: 'PrivateAlert'
...
```bicep
module anomalyAlert 'br/public:cost/subscription-scheduled-action:1.1' = {
  name: 'anomalyAlert'
  params: {
    name: 'AnomalyAlert'
    kind: 'InsightAlert'
