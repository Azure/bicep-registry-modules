...
module kvCert 'br/public:deployment-scripts/create-kv-certificate:2.1.1' = {
  name: 'akvCertSingle'
  params: {
    akvName: akvName
    location: location
...
module kvCert 'br/public:deployment-scripts/create-kv-certificate:2.1.1' = [ for certificateName in certificateNames : {
...
module signedCert 'br/public:deployment-scripts/create-kv-certificate:2.1.1' = {
  name: 'akvCert-${certificateName}'
  params: {
    akvName:  akvName
    location: location
