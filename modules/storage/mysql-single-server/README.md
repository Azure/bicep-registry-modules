...
```bicep
module test01 'br/public:storage/mysql-single-server:1.0.2' = {
...
```bicep
module test02 'br/public:storage/mysql-single-server:1.0.2' = {
...
```bicep
module test03 'br/public:storage/mysql-single-server:1.0.2' = {
  name: 'mysqldb-${uniqueString(deployment().name, location)}-deployment'
  params: {
    prefix: 'mysql-test04'
    location: location
