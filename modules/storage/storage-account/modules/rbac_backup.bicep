...
param containerScope bool = false
...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for principalId in principalIds: {
  name: guid(containerScope ? storage::blob::container.name : storage.name, principalId, roleDefinitionIdOrName)
  properties: {
  ...
  scope: containerScope ? storage::blob::container : storage
}]
