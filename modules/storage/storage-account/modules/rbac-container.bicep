...
resource blob 'Microsoft.Storage/storageAccounts/blobServices@2021-04-01' existing = if (blobName != '') {
  name: blobName
  parent: storage
}

resource container 'Microsoft.Storage/storageAccounts/blobServices/containers@2021-04-01' existing = if (containerName != ''){
  name: containerName
  parent: blob
}

resource containerRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for principalId in principalIds: if (containerName != '') {
