...
// resource virtualNetwork 'Microsoft.Network/virtualNetworks@2021-08-01' existing = if (newOrExistingVnet != 'none') {
//   name: vnetName
//   scope: resourceGroup(vnetResourceGroup)
// }

// resource privateDNSZone 'Microsoft.Network/privateDnsZones@2020-06-01' = if (newOrExistingVnet != 'none') {
...
resource postgresFlexibleServers 'Microsoft.DBforPostgreSQL/flexibleServers@2022-12-01' = {
  ...
  //   name: guid('administrator', location, name)
  //   properties: {
