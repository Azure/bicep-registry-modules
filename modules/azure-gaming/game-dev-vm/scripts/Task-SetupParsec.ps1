param (
    [string]$parsecRegistrationProperties='',
...
function register-team-computer {
    ...
    $Output = Start-Process powershell.exe -argument "-file $env:ProgramData\ParsecLoader\TeamMachineSetup.ps1 -parsecRegistrationProperties $parsecRegistrationProperties" -PassThru -Wait
