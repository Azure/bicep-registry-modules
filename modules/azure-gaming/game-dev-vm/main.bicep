...
resource virtualMachine_GDVMCustomization 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = if (deployedFromSolutionTemplate) {
  ...
  properties: {
    ...
    settings: {
      fileUris: [
        uri(_artifactsLocation, 'scripts/Controller-Initialization.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-CompleteUESetup.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-ConfigureLoginScripts.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-CreateDataDisk.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-MountFileShare.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-SyncP4Depot.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-SetupIncredibuild.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-RegisterTeradici.ps1${_artifactsLocationSasToken}')
        uri(_artifactsLocation, 'scripts/Task-SetupParsec.ps1${_artifactsLocationSasToken}')
