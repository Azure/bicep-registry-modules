...
| `publicAzureAccessEnabled`              | `bool`   | No       | When public network access is disabled, toggle this to allow Azure serices to bypass the public network access rule.                                                                                                                                                                                                                                                                                 |
...
| `zoneRedundancyEnabled`                 | `bool`   | No       | Toggle if Zone Redudancy should be enabled on Azure Container Registry.                                                                                                                                                                                                                                                                                                                              |
