...
This module has been retired and replaced by the following equivalent module in Azure Verified Modules (AVM): [avm/res/cognitive-services/account](https://github.com/Azure/bicep-registry-modules/tree/main/avm/res/cognitive-services/account).
