...
- [Deploying as a Block Blob Storage](#example-1-deploying-as-a-block-blob-storage)
- [Using only defaults](#example-2-using-only-defaults)
- [Using large parameter set](#example-3-using-large-parameter-set)
- [Deploying with a NFS File Share](#example-4-deploying-with-a-nfs-file-share)
...
- [Deploying as Storage Account version 1](#example-7-deploying-as-storage-account-version-1)
- [WAF-aligned](#example-8-waf-aligned)

### Example 1: _Deploying as a Block Blob Storage_
...
### Example 4: _Deploying with a NFS File Share_
...
### Example 7: _Deploying as Storage Account version 1_
