...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`accessKey1`](#parameter-secretsexportconfigurationaccesskey1) | string | Default to Key1Key. The primary key secret name to create. |
| [`accessKey2`](#parameter-secretsexportconfigurationaccesskey2) | string | Default to Key2-Key. The secondary key secret name to create. |
