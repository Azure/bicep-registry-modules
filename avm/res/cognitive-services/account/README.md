...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/cognitive-services/account:0.2.0`.
...
```bicep
module account 'br/public:avm/res/cognitive-services/account:0.2.0' = {
