...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/compute/ssh-public-key:0.2.0`.
...
```bicep
module sshPublicKey 'br/public:avm/res/compute/ssh-public-key:0.2.0' = {
