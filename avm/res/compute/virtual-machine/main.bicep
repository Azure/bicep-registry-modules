...
module vm_aadJoinExtension 'extension/main.bicep' = if (extensionAadJoinConfig.enabled) {
  ...
  params: {
    ...
    typeHandlerVersion: contains(extensionAadJoinConfig, 'typeHandlerVersion') ? extensionAadJoinConfig.typeHandlerVersion : (osType == 'Windows' ? '2.0' : '1.0')
...
module vm_azureGuestConfigurationExtension 'extension/main.bicep' = if (extensionGuestConfigurationExtension.enabled) {
  ...
  params: {
    ...
    settings: contains(extensionGuestConfigurationExtension, 'settings') ? extensionGuestConfigurationExtension.settings : {}
    protectedSettings: contains(extensionGuestConfigurationExtension, 'protectedSettings') ? extensionGuestConfigurationExtension.protectedSettings : {}
