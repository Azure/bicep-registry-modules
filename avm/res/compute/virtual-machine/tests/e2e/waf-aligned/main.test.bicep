...
@description('Required. The object id of the Backup Management Service Enterprise Application. This value is tenant-specific and its value must be configured in the secrets Key Vault as \'CI-BackupManagementServiceEnterpriseApplicationObjectId\'.')
@secure()
