  ...
  properties: union(
    {
      ...
      ipAddress: union(
        ...
        ipAddressType == 'Private' ? { ip: staticIpAddress } : {}
      )
      sku: sku
...
@description('The static IP address of the container group.')
output staticIpAddress string = containergroup.properties.ipAddress.ip ?? ''
...
type staticIpAddressType = {
  @description('Optional. The static IP address to assign when ipAddressType is Private.')
  ipAddress: string
}
