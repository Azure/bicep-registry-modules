...
@description('Conditional. The Dns name label for the resource. Required if `ipAddressType` is `Public`.')
  ...
  properties: union(
    {
      ...
      ipAddress: {
        type: ipAddressType
        autoGeneratedDomainNameLabelScope: !empty(dnsNameLabel) ? autoGeneratedDomainNameLabelScope : null
