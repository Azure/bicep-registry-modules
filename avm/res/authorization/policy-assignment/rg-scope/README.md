...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/authorization/policy-assignment/rg-scope:<version>`.
...
```bicep-params
using 'br/public:avm/res/authorization/policy-assignment/rg-scope:<version>'

// Required parameters
param name = 'rapargmin001'
