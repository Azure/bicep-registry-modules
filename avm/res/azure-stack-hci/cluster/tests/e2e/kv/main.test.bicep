...
metadata name = 'Deploy Azure Stack HCI Cluster in Azure with creating key vault'
metadata description = 'This test deploys an Azure VM with creating key vault, validates the cluster configuration, and then deploys the cluster.'
...
param serviceShort string = 'ashckv'
