...
@description('Optional.Specifies the resource tags for the Azure Monitor managed service for Prometheus resource.')
param tags object = {}
...
@description('Optional.Specifies the api key setting of the Azure Managed Grafana resource.')
@allowed([
  'Disabled'
  'Enabled'
])
...
@description('Optional.Specifies the sku of the Azure Managed Grafana resource.')
param skuName string = 'Standard'

@allowed([
  'TenantReuse'
])
@description('Optional.Specifies the auto generated domain name label scope of the Azure Managed Grafana resource.')
param autoGeneratedDomainNameLabelScope string = 'TenantReuse'

@description('Optional.Specifies the deterministic outbound IP setting of the Azure Managed Grafana resource.')
param deterministicOutboundIP string = 'Disabled'

@description('Optional. Configuration details for enterprise configurations.')
param enterpriseConfigurations grafanaTypes.enterpriseConfigurationsType = {}

@description('Optional. Configuration details for grafana integrations.')
param grafanaIntegrations grafanaTypes.grafanaIntegrationsType = {}

@description('Optional. Configuration details for grafana plugins.')
param grafanaPlugins object = {}

@description('Optional. Specifies the major version of the Azure Managed Grafana resource.')
...
@description('Optional. Configuration details for grafana configurations.')
