...
```bicep
module budget 'br/public:avm/res/consumption/budget/mg-scope:<version>' = {
  params: { (...) }
}
```
...
```bicep-params
using 'br/public:avm/res/consumption/budget/mg-scope:<version>'

// Required parameters
param amount = 500
param name = 'rcbmgmin001'
// Non-required parameters
param contactEmails = [
  'dummy@contoso.com'
]
