...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/key-vault/vault:0.2.0`.
...
```bicep
module vault 'br/public:avm/res/key-vault/vault:0.2.0' = {
