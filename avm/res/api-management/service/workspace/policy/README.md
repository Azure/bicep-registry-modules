# API Management Workspace Policies `[Microsoft.ApiManagement/service/workspaces/policies]`

This module deploys a Policy at API Management Workspace scope.

You can reference the module as follows:
```bicep
module service 'br/public:avm/res/api-management/service/workspace/policy:<version>' = {
  params: { (...) }
}
```
...
| :-- | :-- | :-- |
| `name` | string | The name of the workspace policy. |
| `resourceGroupName` | string | The resource group the workspace policy was deployed into. |
| `resourceId` | string | The resource ID of the workspace policy. |
