...
>**Note**: To reference the module, please use the following syntax `br/public:avm-res-network-dnsforwardingruleset:1.0.0`.
...
```bicep
module dnsForwardingRuleset 'br/public:avm-res-network-dnsforwardingruleset:1.0.0' = {
