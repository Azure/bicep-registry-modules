...
module testDeployment '../../../main.bicep' = [
  for iteration in ['init', 'idem']: {
    ...
    params: {
      ...
      existingPrimaryPublicIPResourceId: nestedDependencies.outputs.existingPrimaryPublicIPResourceId
      clusterSettings: {
        clusterMode: 'activeActiveNoBgp'
        existingSecondaryPublicIPResourceId: nestedDependencies.outputs.existingSecondaryPublicIPResourceId
      }
