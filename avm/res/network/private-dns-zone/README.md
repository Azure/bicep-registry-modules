...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/network/private-dns-zone:0.2.0`.
...
```bicep
module privateDnsZone 'br/public:avm/res/network/private-dns-zone:0.2.0' = {
