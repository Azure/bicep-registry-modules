...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/network/network-interface:0.2.0`.
...
```bicep
module networkInterface 'br/public:avm/res/network/network-interface:0.2.0' = {
