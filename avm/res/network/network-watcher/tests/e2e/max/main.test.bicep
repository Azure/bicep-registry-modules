...
@description('Optional. The location of the resource group to deploy resources to.') // Note, we set the location of the NetworkWatcherRG to avoid conflicts with already existing NetworkWatcherRG
