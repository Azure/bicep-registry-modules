...
param authenticationCertificates resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.authenticationCertificates = []
...
param backendAddressPools resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.backendAddressPools = []

@description('Optional. Backend http settings of the application gateway resource.')
param backendHttpSettingsCollection resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.backendHttpSettingsCollection = []

@description('Optional. Custom error configurations of the application gateway resource.')
param customErrorConfigurations resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.customErrorConfigurations = []
...
param frontendIPConfigurations resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.frontendIPConfigurations = []

@description('Optional. Frontend ports of the application gateway resource.')
param frontendPorts resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.frontendPorts = []

@description('Optional. Subnets of the application gateway resource.')
param gatewayIPConfigurations resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.gatewayIPConfigurations = []
...
param httpListeners resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.httpListeners = []

@description('Optional. Load distribution policies of the application gateway resource.')
param loadDistributionPolicies resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.loadDistributionPolicies = []
...
param privateLinkConfigurations resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.privateLinkConfigurations = []

@description('Optional. Probes of the application gateway resource.')
param probes resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.probes = []

@description('Optional. Redirect configurations of the application gateway resource.')
param redirectConfigurations resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.redirectConfigurations = []

@description('Optional. Request routing rules of the application gateway resource.')
param requestRoutingRules resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.requestRoutingRules = []

@description('Optional. Rewrite rules for the application gateway resource.')
param rewriteRuleSets resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.rewriteRuleSets = []
...
param sslCertificates resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.sslCertificates = []

@description('Optional. Ssl cipher suites to be enabled in the specified order to application gateway.')
param sslPolicyCipherSuites resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.sslPolicy.cipherSuites = [
...
param sslProfiles resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.sslProfiles = []

@description('Optional. Trusted client certificates of the application gateway resource.')
param trustedClientCertificates resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.trustedClientCertificates = []

@description('Optional. Trusted Root certificates of the application gateway resource.')
param trustedRootCertificates resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.trustedRootCertificates = []

@description('Optional. URL path map of the application gateway resource.')
param urlPathMaps resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.urlPathMaps = []
...
param tags resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.tags?
...
param backendSettingsCollection resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.backendSettingsCollection = []
...
param listeners resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.listeners = []

@description('Optional. Routing rules of the application gateway resource.')
param routingRules resourceInput<'Microsoft.Network/applicationGateways@2024-10-01'>.properties.routingRules = []
