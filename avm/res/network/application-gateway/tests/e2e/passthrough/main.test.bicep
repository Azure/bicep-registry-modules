...
metadata name = 'Using mTLS Passthrough'
...
param serviceShort string = 'nagpst'
      ...
      httpListeners: [
        {
          ...
          properties: {
            ...
            sslProfile: {
              id: '${appGWExpectedResourceID}/sslProfiles/sslProfiles'
            }
          }
        }
        {
      ...
      sslProfiles: [
        {
          ...
          id: '${appGWExpectedResourceID}/sslProfiles/sslnotrustedcert'
          properties: {
