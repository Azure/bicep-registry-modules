# Public DNS Zone DS record `[Microsoft.Network/dnsZones/DS]`

This module deploys a Public DNS Zone DS record.

You can reference the module as follows:
```bicep
module dnsZone 'br/public:avm/res/network/dns-zone/ds:<version>' = {
  params: { (...) }
}
```
...
| :-- | :-- | :-- |
| [`name`](#parameter-name) | string | The name of the DS record. |
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`dsRecords`](#parameter-dsrecords) | array | The list of DS records in the record set. |
...
| :-- | :-- | :-- |
| `name` | string | The name of the deployed DS record. |
| `resourceGroupName` | string | The resource group of the deployed DS record. |
| `resourceId` | string | The resource ID of the deployed DS record. |
