...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/network/dns-zone:0.2.0`.
...
```bicep
module dnsZone 'br/public:avm/res/network/dns-zone:0.2.0' = {
