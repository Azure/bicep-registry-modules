...
>**Note**: To reference the module, please use the following syntax `br/public:avm-res-network-routetable:1.0.0`.
...
```bicep
module routeTable 'br/public:avm-res-network-routetable:1.0.0' = {
