...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/network/dns-resolver:0.2.0`.
...
```bicep
module dnsResolver 'br/public:avm/res/network/dns-resolver:0.2.0' = {
