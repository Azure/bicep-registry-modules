...
@description('Required. The object id of the AzureDatabricks Enterprise Application. This value is tenant-specific and its value must be configured in the CI Key Vault as \'CI-AzureDatabricksEnterpriseApplicationObjectId\'.')
@secure()
