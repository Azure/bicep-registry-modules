...
module testDeployment '../../../main.bicep' = [
  for iteration in ['init', 'idem']: {
    ...
    params: {
      ...
      complianceSecurityProfileValue: 'Disabled' // If this is set to 'Enabled', then the complianceStandards must be set to 'HIPAA', 'NONE' or 'PCI_DSS' and the enhancedSecurityMonitoring must be set to 'Enabled' as well as the automaticClusterUpdate
