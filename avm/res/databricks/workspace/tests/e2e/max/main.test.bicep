...
#disable-next-line no-hardcoded-location // services used for this module are only available in major regions such as westeurope
var tempLocation = 'westeurope'
