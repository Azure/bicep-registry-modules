...
>**Note**: To reference the module, please use the following syntax `br/public:avm/res/code-signing/code-signing-account:<version>`.
...
| :-- | :-- | :-- |
| [`name`](#parameter-name) | string | The name of the Azure Code Signing Account. |
| [`skuName`](#parameter-skuname) | string | The name of the Azure Code Signing Account SKU. |
...
The name of the Azure Code Signing Account.
...
| `name` | string | The name of the codeSigningAccount. |
| `resourceGroupName` | string | The name of the resource group the codeSigningAccount was created in. |
| `resourceId` | string | The resource ID of the codeSigningAccount. |
