...
- Upgraded `Microsoft.HybridCompute/machines` API version from `2024-07-10` to `2025-06-01`
- Upgraded `Microsoft.HybridCompute/machines/extensions` API version from `2024-07-10` to `2025-06-01`
- Upgraded `Microsoft.GuestConfiguration/guestConfigurationAssignments` API version from `2020-06-25` to `2024-04-05`
- Upgraded `Microsoft.HybridCompute/privateLinkScopes` (test dependency) from `2023-10-03-preview` to `2025-06-01`
