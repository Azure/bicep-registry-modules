...
| :-- | :-- | :-- |
| `Microsoft.HybridCompute/licenses` | 2025-06-01 | <ul style="padding-left: 0px;"><li>[AzAdvertizer](https://www.azadvertizer.net/azresourcetypes/microsoft.hybridcompute_licenses.html)</li><li>[Template reference](https://learn.microsoft.com/en-us/azure/templates/Microsoft.HybridCompute/2025-06-01/licenses)</li></ul> |
