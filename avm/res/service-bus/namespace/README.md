...
| Name | Required | Type | Description |
| :-- | :-- | :--| :-- |
| [`capacity`](#parameter-skuobjectcapacity) | No | int | Optional. The specified messaging units for the tier. Only used for Premium Sku tier. |
| [`name`](#parameter-skuobjectname) | Yes | string | Required. Name of this SKU. - Basic, Standard, Premium. |

### Parameter: `skuObject.capacity`

Optional. The specified messaging units for the tier. Only used for Premium Sku tier.
...
Required. Name of this SKU. - Basic, Standard, Premium.
