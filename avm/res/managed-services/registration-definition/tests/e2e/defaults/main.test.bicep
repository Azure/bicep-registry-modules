...
@description('Required. The thenant Id of the lighthouse tenant. This value is tenant-specific and its value must be configured in the secrets Key Vault as \'CI-LighthouseManagedByTenantId\'.')
@secure()
