...
@description('Required. The tenant Id of the lighthouse tenant. This value is tenant-specific and its value must be configured in the CI Key Vault as \'CI-LighthouseManagedByTenantId\'.')
@secure()
