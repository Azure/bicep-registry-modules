...
var identity = !empty(managedIdentities) && ((managedIdentities.?systemAssigned ?? false) || !empty(formattedUserAssignedIdentities)) || !empty(formattedUserAssignedIdentities)
  ? {
