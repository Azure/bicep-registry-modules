...
| `Microsoft.Batch/batchAccounts` | [2024-07-01](https://learn.microsoft.com/en-us/azure/templates/Microsoft.Batch/2024-07-01/batchAccounts) |
...
param storageAccessIdentityResourceId = '<storageAccessIdentityResourceId>'
param storageAuthenticationMode = 'BatchAccountManagedIdentity'
param tags = {
  Environment: 'Non-Prod'
  'hidden-title': 'This is visible in the resource name'
