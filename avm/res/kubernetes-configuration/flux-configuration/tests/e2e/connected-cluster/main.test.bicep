...
var enforcedLocation = 'austriaeast'
...
module pci 'br/public:avm/res/hybrid-container-service/provisioned-cluster-instance:0.2.1' = {
...
module k8scluster 'dependencies.bicep' = {
  scope: resourceGroup
