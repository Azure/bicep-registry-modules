...
var builtInRoleNames = {
  ...
  'Azure Front Door Profile Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '662802e2-50f6-46b0-aed2-e834bacc6d12')
  'Azure Programmable Connectivity Gateway User': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '609c0c20-e0a0-4a71-b99f-e7e755ac493d')
  'Azure Sphere Contributor': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '8b9dfcab-4b77-4632-a6df-94bd07820648')
  'Azure Sphere Publisher': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '6d994134-994b-4a59-9974-f479f0b227fb')
  'Azure Sphere Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'c8ae6279-5a0b-4cb2-b3f0-d4d62845742c')
  ...
  'HDInsight on AKS Cluster Admin': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'fd036e6b-1266-47a0-b0bb-a05d04831731')
  'HDInsight on AKS Cluster Pool Admin': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '7656b436-37d4-490a-a4ab-d39f838f0042')
  ...
  'KubernetesRuntime Storage Class Contributor Role': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '0cd9749a-3aaf-4ae5-8803-bd217705bf3b')
  ...
  'Logic Apps Standard Contributor (Preview)': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'ad710c24-b039-4e85-a019-deb4a06e8570')
  'Logic Apps Standard Developer (Preview)': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '523776ba-4eb2-4600-a3c8-f2dc93da4bdb')
  'Logic Apps Standard Operator (Preview)': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'b70c96e9-66fe-4c09-b6e7-c98e69c98555')
  'Logic Apps Standard Reader (Preview)': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '4accf36b-2c05-432f-91c8-5c532dff4c73')
...
resource avmTelemetry 'Microsoft.Resources/deployments@2023-07-01' = if (enableTelemetry) {
  name: '46d3xbcp.res.insights-privatelinkscopeopstatus.${replace('-..--..-', '.', '-')}.${substring(uniqueString(deployment().name, location), 0, 4)}'
  properties: {
    mode: 'Incremental'
    template: {
...
module privateLinkScope_privateEndpoints 'br/public:avm/res/network/private-endpoint:0.3.1' = [for (privateEndpoint, index) in (privateEndpoints ?? []): {
