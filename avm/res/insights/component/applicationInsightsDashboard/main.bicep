metadata name = 'Application Insights Dashboard'
metadata description = 'This component deploys an Application Insights Dashboard.'
metadata owner = 'Azure/module-maintainers'

@description('Required. The name of the dashboard for an Application Insights instance.')
param name string
