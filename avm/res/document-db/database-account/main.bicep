...
param analyticalStorageConfiguration resourceInput<'Microsoft.DocumentDB/databaseAccounts@2026-03-15'>.properties.analyticalStorageConfiguration?

@description('Optional. The CORS policy for the Cosmos DB database account.')
param cors resourceInput<'Microsoft.DocumentDB/databaseAccounts@2026-03-15'>.properties.cors?
...
type gremlinDatabaseType = {
  ...
  tags: resourceInput<'Microsoft.DocumentDB/databaseAccounts/gremlinDatabases@2026-03-15'>.tags?
...
type mongoDbType = {
  ...
  autoscaleSettings: resourceInput<'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases@2026-03-15'>.properties.options.autoscaleSettings?

  @description('Optional. Tags of the resource.')
  tags: resourceInput<'Microsoft.DocumentDB/databaseAccounts/mongodbDatabases@2026-03-15'>.tags?
}
...
type tableType = {
  ...
  tags: resourceInput<'Microsoft.DocumentDB/databaseAccounts/tables@2026-03-15'>.tags?
...
type cassandraRoleDefinitionType = {
  ...
  @description('Optional. An array of data actions that are allowed. Note: Valid data action strings are currently undocumented (API version 2026-03-15). Expected to follow format similar to SQL RBAC once documented by Microsoft.')
  dataActions: string[]?

  @description('Optional. An array of data actions that are denied. Note: Unlike SQL RBAC, Cassandra supports deny rules for granular access control. Valid data action strings are currently undocumented (API version 2026-03-15).')
...
type cassandraKeyspaceType = {
  ...
  tags: resourceInput<'Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces@2026-03-15'>.tags?
}
