...
param conflictResolutionPolicy resourceInput<'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2026-03-15'>.properties.resource.conflictResolutionPolicy?
...
param tags resourceInput<'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2026-03-15'>.tags?
...
param indexingPolicy resourceInput<'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2026-03-15'>.properties.resource.indexingPolicy?
...
param uniqueKeyPolicyKeys resourceInput<'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2026-03-15'>.properties.resource.uniqueKeyPolicy.uniqueKeys?

@description('Optional. The vector embedding policy for the container.')
param vectorEmbeddingPolicy resourceInput<'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2026-03-15'>.properties.resource.vectorEmbeddingPolicy?

@description('Optional. The full text policy for the container.')
param fullTextPolicy resourceInput<'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2026-03-15'>.properties.resource.fullTextPolicy?
...
resource databaseAccount 'Microsoft.DocumentDB/databaseAccounts@2026-03-15' existing = {
  ...
  resource sqlDatabase 'sqlDatabases@2026-03-15' existing = {
