...
```bicep
module databaseAccount 'br/public:avm/res/document-db/database-account/sql-database/container:<version>' = {
  params: { (...) }
}
```
...
| [`dataMaskingPolicy`](#parameter-datamaskingpolicy) | object | Data masking policy of the container. |
...
### Parameter: `dataMaskingPolicy`

Data masking policy of the container.
