...
- [Using encryption with Customer-Managed-Key](#example-6-using-encryption-with-customer-managed-key)
...
### Example 6: _Using encryption with Customer-Managed-Key_
