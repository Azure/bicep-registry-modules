...
| [`minimumTlsVersionAllowed`](#parameter-minimumtlsversionallowed) | string | The minimum TLS version allowed for the Event Grid Domain. |
...
The minimum TLS version allowed for the Event Grid Domain.
