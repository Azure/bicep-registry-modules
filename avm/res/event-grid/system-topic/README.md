...
>**Note**: To reference the module, please use the following syntax `br/public:AVM/eg-systemtopic/bicep-registry-modules:<version>`.
...
```bicep
module systemTopic 'br/public:AVM/eg-systemtopic/bicep-registry-modules:<version>' = {
