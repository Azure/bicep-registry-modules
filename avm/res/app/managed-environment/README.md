...
- [No App Logging](#example-4-no-app-logging)
...
param internal = true
param logsDestination = 'azure-monitor'
...
### Example 4: _No App Logging_

This instance deploys the module with app logging disabled.
