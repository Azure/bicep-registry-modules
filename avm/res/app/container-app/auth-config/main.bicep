...
param encryptionSettings resourceInput<'Microsoft.App/containerApps/authConfigs@2025-07-01'>.properties.encryptionSettings?
...
param globalValidation resourceInput<'Microsoft.App/containerApps/authConfigs@2025-07-01'>.properties.globalValidation?
...
param httpSettings resourceInput<'Microsoft.App/containerApps/authConfigs@2025-07-01'>.properties.httpSettings?
...
param identityProviders resourceInput<'Microsoft.App/containerApps/authConfigs@2025-07-01'>.properties.identityProviders?
...
param login resourceInput<'Microsoft.App/containerApps/authConfigs@2025-07-01'>.properties.login?

@description('Optional. The configuration settings of the platform of ContainerApp Service Authentication/Authorization.')
param platform resourceInput<'Microsoft.App/containerApps/authConfigs@2025-07-01'>.properties.platform?
...
resource containerAppAuthConfigs 'Microsoft.App/containerApps/authConfigs@2025-07-01' = {
  name: 'current'
  parent: containerApp
  properties: {
