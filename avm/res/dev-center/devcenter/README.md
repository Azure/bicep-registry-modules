...
Project policies provide a mechanism to restrict access to certain resourcesΓÇöspecifically, SKUs, Images, and Network ConnectionsΓÇöto designated projects. Creating a policy does not mean it has automatically been enforced on the selected projects. It must be explicitly assigned to a project as part of the scope property. You must first create the "Default" project policy before you can create any other project policies. The "Default" project policy is automatically assigned to all projects in the Dev Center.
