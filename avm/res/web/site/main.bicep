...
@description('Optional. Indicates the endpoint name reuse scope. The default value is disabled.')
@allowed([
  'NoReuse'
  'ResourceGroupReuse'
  'SubscriptionReuse'
...
resource app 'Microsoft.Web/sites@2024-04-01' = {
  ...
  properties: {
    ...
    autoGeneratedDomainNameLabelScope: !empty(autoGeneratedDomainNameLabelScope)
