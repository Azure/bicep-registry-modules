...
metadata name = 'Multi-Authentication (MSI)'
metadata description = 'This instance deploys the module with multi-authentication managed identity configuration using parameterValueSet.'
...
param serviceShort string = 'wcma'
