...
metadata name = 'Single-Authentication (MSI)'
metadata description = 'This instance deploys the module with single-authentication managed identity configuration.'
...
param serviceShort string = 'wcsa'
