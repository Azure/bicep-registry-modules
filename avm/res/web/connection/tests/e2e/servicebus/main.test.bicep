...
metadata name = 'Using a Service Bus connection'
metadata description = 'This instance deploys the module with a connection to Service Bus.'
...
param serviceShort string = 'wcsb'
  ...
  for iteration in ['init', 'idem']: {
    ...
    params: {
      ...
      parameterValueSet: {
        ...
        values: {
          namespaceEndpoint: {
            value: 'sb://${nestedDependencies.outputs.serviceBusEndpoint}'
          }
        }
      }
      tags: {
