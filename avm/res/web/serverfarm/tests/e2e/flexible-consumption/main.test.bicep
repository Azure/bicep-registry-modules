...
metadata name = 'Flexible Consumption'
metadata description = 'This instance deploys the module in a flexible consumption app service plan.'
...
param serviceShort string = 'wsffcp'
