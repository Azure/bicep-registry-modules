...
Describe 'File/folder tests' -Tag 'Modules' {
    ...
    Context 'General module folder tests' {
        ...
        It '[<moduleFolderName>] Child module should not contain a [` version.json `] file.' -TestCases ($moduleFolderTestCases | Where-Object { (-Not $_.isTopLevelModule) -And ($_.moduleFolderName -ne 'avm/res/network/virtual-network/subnet') }) {
