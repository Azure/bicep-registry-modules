...
var runtimeVersionSiteConfig = !empty(runtimeVersion)
  ? (isLinux
      ...
      : windowsRuntimeVersionConfigMap[functionWorkerRuntime])
  : {}
      ...
      ? [
          {
            ...
            privateDnsZoneGroup: !empty(privateDnsZoneResourceIds.?blob)
              ? {
                  privateDnsZoneGroupConfigs: [
                    { privateDnsZoneResourceId: privateDnsZoneResourceIds!.blob! }
                  ]
                }
              : null
          }
          {
            ...
            service: 'file'
            subnetResourceId: privateEndpointSubnetResourceId
            privateDnsZoneGroup: !empty(privateDnsZoneResourceIds.?file)
              ? {
                  privateDnsZoneGroupConfigs: [
                    { privateDnsZoneResourceId: privateDnsZoneResourceIds!.file! }
                  ]
                }
              : null
          }
          {
            ...
            service: 'queue'
            subnetResourceId: privateEndpointSubnetResourceId
            privateDnsZoneGroup: !empty(privateDnsZoneResourceIds.?queue)
              ? {
                  privateDnsZoneGroupConfigs: [
                    { privateDnsZoneResourceId: privateDnsZoneResourceIds!.queue! }
                  ]
                }
              : null
          }
          {
            ...
            service: 'table'
            subnetResourceId: privateEndpointSubnetResourceId
            privateDnsZoneGroup: !empty(privateDnsZoneResourceIds.?table)
              ? {
                  privateDnsZoneGroupConfigs: [
                    { privateDnsZoneResourceId: privateDnsZoneResourceIds!.table! }
                  ]
                }
              : null
          }
      ...
      ? [
          {
            ...
            service: 'sites'
            subnetResourceId: privateEndpointSubnetResourceId
            privateDnsZoneGroup: !empty(privateDnsZoneResourceIds.?sites)
              ? {
                  privateDnsZoneGroupConfigs: [
                    { privateDnsZoneResourceId: privateDnsZoneResourceIds!.sites! }
                  ]
                }
              : null
          }
