...
metadata name = 'No Addons'
metadata description = 'This instance deploys the module with no add-ons (Firewall / Bastion) enabled.'
...
param serviceShort string = 'nhnnadd'

@description('Optional. A token to inject into the name of each resource.')
param namePrefix string = 'ksbz'
