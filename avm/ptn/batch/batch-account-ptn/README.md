# Batch Accounts `[Microsoft.Batch/batchaccountptn]`
...
>**Note**: To reference the module, please use the following syntax `br/public:avm/ptn/batch/batch-account-ptn:<version>`.
...
```bicep
module batchAccountPtn 'br/public:avm/ptn/batch/batch-account-ptn:<version>' = {
  name: 'batchAccountPtnDeployment'
  params: {
    // Required parameters
    name: 'bbamin001'
