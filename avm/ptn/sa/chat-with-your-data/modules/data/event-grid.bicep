...
// ============================================================================
module eventGridSystemTopic 'br/public:avm/res/event-grid/system-topic:0.7.0' = {
...
// the required role.
// ============================================================================
module eventGridSystemTopicWithSubscriptions 'br/public:avm/res/event-grid/system-topic:0.7.0' = if (!empty(eventSubscriptions)) {
