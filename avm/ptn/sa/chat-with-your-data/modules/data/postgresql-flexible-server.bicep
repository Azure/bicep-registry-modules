...
// ============================================================================
module postgresServer 'br/public:avm/res/db-for-postgre-sql/flexible-server:0.16.0' = {
...
@batchSize(1)
resource serverConfigurations 'Microsoft.DBforPostgreSQL/flexibleServers/configurations@2024-08-01' = [
