...
param publicContainerImageEndpoint string = 'containermigrationacr.azurecr.io'
...
param tags resourceInput<'Microsoft.Resources/resourceGroups@2025-04-01'>.tags = {
  app: 'Container Migration Solution Accelerator'
...
module avmAppConfig 'br/public:avm/res/app-configuration/configuration-store:0.9.2' = {
  ...
  params: {
    ...
    keyValues: [
      ...
      {
        name: 'APP_CMS_CONFIGURATION'
        value: 'cms-configuration'
      }
      {
        name: 'APP_CMS_MAX_FILESIZE_MB'
        value: '20'
      }
      {
        name: 'APP_CMS_PROCESSES'
        value: 'cms-processes'
      }
      {
