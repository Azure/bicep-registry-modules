...
metadata description = '''This module deploys the [Modernize Your Code Solution Accelerator](https://github.com/microsoft/Modernize-your-code-solution-accelerator).
...
@minLength(3)
@maxLength(16)
@description('Required. (TODO - random increment to trigger changes 001 - remove this at some point) A unique application/solution name for all resources in this deployment. This should be 3-16 characters long..')
