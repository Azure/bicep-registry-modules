...
resource virtualHub 'Microsoft.Network/virtualHubs@2023-11-01' existing = {
  name: virtualHubName
}

resource hubVirtualNetworkConnection 'Microsoft.Network/virtualHubs/hubVirtualNetworkConnections@2023-11-01' = {
  name: name
  parent: virtualHub
  properties: {
