...
var virtualNetworkLinks = !empty(vnetHubResourceId)
  ? [
      {
...
resource vnetHub 'Microsoft.Network/virtualNetworks@2022-07-01' existing = if (!empty(vnetHubResourceId)) {
...
module jumpboxLinuxVM '../compute/linux-vm.bicep' = if (deployJumpHost && vmJumpboxOSType == 'linux') {
  ...
  params: {
    ...
    vmSubnetName: networking.outputs.snetDevOpsId
