...
param webAppConfig webAppConfigType?
...
// Web App
var webAppKind = webAppConfig.?kind ?? 'app'
var httpsOnly = webAppConfig.?httpsOnly ?? true
var clientCertEnabled = webAppConfig.?clientCertEnabled ?? false
var clientCertMode = webAppConfig.?clientCertMode ?? 'Required'
var clientCertExclusionPaths = webAppConfig.?clientCertExclusionPaths
var disableBasicPublishingCredentials = webAppConfig.?disableBasicPublishingCredentials ?? true
var webAppPublicNetworkAccess = webAppConfig.?publicNetworkAccess ?? ''
var redundancyMode = webAppConfig.?redundancyMode ?? 'None'
var scmSiteAlsoStopped = webAppConfig.?scmSiteAlsoStopped ?? false
var siteConfig = webAppConfig.?siteConfig ?? {
  alwaysOn: true
  ftpsState: 'FtpsOnly'
  minTlsVersion: '1.2'
...
var functionAppConfig = webAppConfig.?functionAppConfig
var managedEnvironmentResourceId = webAppConfig.?managedEnvironmentResourceId
var outboundVnetRouting = webAppConfig.?outboundVnetRouting
var hostNameSslStates = webAppConfig.?hostNameSslStates
var e2eEncryptionEnabled = webAppConfig.?e2eEncryptionEnabled
var keyVaultAccessIdentityResourceId = webAppConfig.?keyVaultAccessIdentityResourceId
var hybridConnectionRelays = webAppConfig.?hybridConnectionRelays
var webAppExtensions = webAppConfig.?extensions
var webAppEnabled = webAppConfig.?enabled ?? true
var cloningInfo = webAppConfig.?cloningInfo
var containerSize = webAppConfig.?containerSize
var dailyMemoryTimeQuota = webAppConfig.?dailyMemoryTimeQuota
var storageAccountRequired = webAppConfig.?storageAccountRequired ?? false
var dnsConfiguration = webAppConfig.?dnsConfiguration
var autoGeneratedDomainNameLabelScope = webAppConfig.?autoGeneratedDomainNameLabelScope
var sshEnabled = webAppConfig.?sshEnabled
var daprConfig = webAppConfig.?daprConfig
var ipMode = webAppConfig.?ipMode
var resourceConfig = webAppConfig.?resourceConfig
var workloadProfileName = webAppConfig.?workloadProfileName
var hostNamesDisabled = webAppConfig.?hostNamesDisabled
var webAppReserved = webAppConfig.?reserved
var extendedLocation = webAppConfig.?extendedLocation
var clientAffinityEnabled = webAppConfig.?clientAffinityEnabled ?? false
var clientAffinityProxyEnabled = webAppConfig.?clientAffinityProxyEnabled
var clientAffinityPartitioningEnabled = webAppConfig.?clientAffinityPartitioningEnabled
var containerImageName = webAppConfig.?container.?imageName ?? ''
var containerRegistryUrl = webAppConfig.?container.?registryUrl ?? ''
var containerRegistryUsername = webAppConfig.?container.?registryUsername ?? ''
var containerRegistryPassword = webAppConfig.?container.?registryPassword ?? ''
var webAppLock = webAppConfig.?lock
var webAppRoleAssignments = webAppConfig.?roleAssignments
var appserviceDiagnosticSettings = webAppConfig.?diagnosticSettings ?? []
