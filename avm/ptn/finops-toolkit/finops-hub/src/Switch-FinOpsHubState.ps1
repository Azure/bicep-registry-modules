...
.EXAMPLE
    ...
    .\Switch-FinOpsHubState.ps1 -ResourceGroupName "finops-rg" -HubName "myfinopshub" -Operation Pause

.EXAMPLE
    # Resume the hub (start processing data again)
    .\Switch-FinOpsHubState.ps1 -ResourceGroupName "finops-rg" -HubName "myfinopshub" -Operation Resume

.EXAMPLE
    # Pause with explicit resource names
    .\Switch-FinOpsHubState.ps1 -ResourceGroupName "finops-rg" -DataFactoryName "adf-myfinopshub-abc123" -AdxClusterName "myfinopsadx" -Operation Pause
