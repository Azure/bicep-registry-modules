...
### 4. Dashboard Query Functions

Dashboard query functions (anomaly detection, forecasting, FOCUS use cases, MACC analysis) are maintained in the official [Microsoft FinOps Toolkit](https://aka.ms/finops/toolkit) repository.
