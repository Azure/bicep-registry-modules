...
This AVM module is aligned with **[FinOps Toolkit](https://aka.ms/finops/toolkit) v0.12** and the **[FOCUS Specification](https://focus.finops.org/) 1.0r2**.
...
| ADX Dashboard | [FinOps Toolkit](https://aka.ms/finops/toolkit) |
...
| **Demo** | PAYGO, CSP, Dev | POCs and demos with test data | [FinOps Toolkit](https://aka.ms/finops/toolkit) |
...
|--------|----------|----------|---------------|
| **ADX Dashboard** | External | Central FinOps team, real-time analysis | [FinOps Toolkit](https://aka.ms/finops/toolkit) |
