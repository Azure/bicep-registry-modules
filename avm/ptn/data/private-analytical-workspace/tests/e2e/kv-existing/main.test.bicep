...
metadata name = 'Using defaults with provided existing Azure Key Vault'
metadata description = 'This instance deploys the module with the minimum set of required parameters and with provided existing Azure Key Vault.'
...
param serviceShort string = 'dpawminkv'
...
module nestedDependencies 'dependencies.bicep' = {
  ...
  params: {
    location: resourceLocation
    keyVaultName: 'dep-${namePrefix}-law-${serviceShort}'
  }
}
