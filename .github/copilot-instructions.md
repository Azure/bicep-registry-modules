...
| AVM-Module-Maintenance      | Comprehensive maintenance analysis for AVM Bicep modules. USE FOR: module maintenance, tech debt analysis, API version update, AVM compliance check, test coverage audit, module health check.   | `.github/skills/avm-module-maintenance/SKILL.md`      |
