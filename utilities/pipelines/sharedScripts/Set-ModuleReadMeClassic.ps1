...
.EXAMPLE
Set-ModuleReadMeClassic -TemplateFilePath 'C:\main.bicep'

Update the readme in path 'C:\README.md' based on the bicep template in path 'C:\main.bicep'

.EXAMPLE
Set-ModuleReadMeClassic -TemplateFilePath 'C:/network/load-balancer/main.bicep' -SectionsToRefresh @('Parameters', 'Outputs')
...
.EXAMPLE
Set-ModuleReadMeClassic -TemplateFilePath 'C:/network/load-balancer/main.bicep' -PreLoadedContent @{ TemplateFileContent = @{...} }
...
.EXAMPLE
Set-ModuleReadMeClassic -TemplateFilePath 'C:/network/load-balancer/main.bicep' -ReadMeFilePath 'C:/differentFolder'
...
$templatePaths | ForEach-Object -Parallel { . '<PathToRepo>/utilities/tools/Set-ModuleReadMeClassic.ps1' ; Set-ModuleReadMeClassic -TemplateFilePath $_ }

Generate the Module ReadMe for any template in a folder path
#>
function Set-ModuleReadMeClassic {
