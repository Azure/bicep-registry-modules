...
function Initialize-DeploymentRemoval {
    ...
    process {
        ...
        $RemoveFirstSequence = @(
            ...
            'Microsoft.NetApp/netAppAccounts/capacityPools/volumes', # Must be deleted before netapp account capacity pool & attached policies
            'Microsoft.NetApp/netAppAccounts/backupPolicies', # Must be deleted before netapp volume backup can be removed
